...
int main()
{
	...
	// --------------------
	const char* vertexShaderPath = "..\\Shader\\VertexShader\\6.2.coordinate_systems.vs";
	const char* fragmentShaderPath = "..\\Shader\\FragmentShader\\6.2.coordinate_systems.fs";
